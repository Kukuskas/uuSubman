...
const Init = {
  UC_CODE: `${SubmanMainUseCaseError.ERROR_PREFIX}init/`,
  ...
  SetProfileFailed: class extends SubmanMainUseCaseError {
    constructor() {
      super(...arguments);
  ...
  CreateAwscFailed: class extends SubmanMainUseCaseError {
    constructor() {
      super(...arguments);
