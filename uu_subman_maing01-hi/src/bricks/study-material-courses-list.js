...
const StudyMaterialCoursesList = createVisualComponent({
  //@@viewOn:statics
  displayName: Config.TAG + "StudyMaterialCoursesList",
  //@@viewOff:statics
  ...
  console.log();
    ...
    function renderItem(item) {
      ...
      if (item.length === 0) {
        ...
        return (
          item.data.productCode !=="Books" &&  item.data.productCode !== "Videos" ?
...
export default StudyMaterialCoursesList;
